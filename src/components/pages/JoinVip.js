   ...
   <PricingTable /> 
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.heading}>HOW TO PAY WITH MPESA FROM TANZANIA</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.heading}>HOW TO PAY WITH MPESA RWANDA</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.heading}>HOW TO PAY WITH MPESA UGANDA </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
